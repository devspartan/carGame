...
class Object:
    ...
    def randomAllocation(self):                    #allocates random position to obstacles
        ...
        yStarting = [-100, -700, -1400, -1900, -2700, -3700, -4400, -5000]
...
def gameOn(genomes, config):
    ...
    netScore = 0
    netSafety = 100
    while True and len(cars) > 0:                        # game on loop
        gameDis.fill(grey)
        drawBoundary()
...
display_width = 600
display_height = 900
gameDis = createDisplay(1200, display_height, "myGame")
